...
@implementation PXSectionDataMapper
...
{
    static PXSectionDataMapper *_instance = nil;
...
{
    if (!self.isLoad) {
        [PXSectionDataLookup readSectionName:PX_CORE_SECTION_NAME
