...
RESIGN_URI(t)                                                \
{                                                           \
    YOYRouteHandlerBlock block = ^BOOL (YOYRoute *route){                                       \
    ...
    [[YOYRouteManager defaultManager] setObject:block forKeyedListSubscript:uriList];    \
}                                                                               \
goto(t)
...
@interface YOYRouterService : NSObject
