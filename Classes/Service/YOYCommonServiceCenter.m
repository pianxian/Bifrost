...
static YOYCommonServiceCenter *_serviceCenter = nil;

@interface YOYCommonServiceCenter () {
...
@implementation YOYCommonServiceCenter
...
+ (YOYCommonServiceCenter *)defaultCenter
{
    ...
    dispatch_once(&onceToken, ^{
        _serviceCenter = [[YOYCommonServiceCenter alloc] init];
    });
